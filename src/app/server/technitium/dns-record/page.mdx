...
![technitium-record-1](/image/technitium/technitium-record-1.png)
...
- **IPv4 Address:** ระบุ IP Address ของ Web Server ที่ต้องการชี้ไป (เช่น `10.11.254.15`)
  ...
  ![technitium-record-2](/image/technitium/technitium-record-2.png)
...
![technitium-record-3](/image/technitium/technitium-record-3.png)
