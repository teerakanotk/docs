...
Technitium DNS คือ **DNS Server แบบโอเพนซอร์ส** ที่ใช้งานง่าย มาพร้อม Web-based Dashboard ที่ช่วยให้การจัดการระบบ DNS เป็นเรื่องง่าย ไม่ว่าจะเป็นการทำหน้าที่เป็น **Authoritative DNS** (จัดการโซน DNS ของตัวเอง) หรือ **Recursive Resolver** (สอบถาม DNS จากเซิร์ฟเวอร์ภายนอก)
...
Forward Zone ใช้สำหรับจับคู่ชื่อโดเมนกับ IP Address เช่น การระบุให้ `www.ctsurin.local` ชี้ไปที่ `192.168.1.10`
...
- คลิกขวาที่ Network adapter ที่เชื่อมต่อกับเครือข่ายเดียวกับ DNS Server
