...
- ไปที่เมนู `Settings` > `General`
  ...
  ![technitium-dns-1](/images/technitium/technitium-dns-1.png)

- เลื่อนลงมาที่หัวข้อ `Zone Defaults`

  - เลือก ☑️ ที่ช่อง `Use SOA Serial Date Scheme`

  ![technitium-dns-2](/images/technitium/technitium-dns-2.png)
...
- ในหัวข้อ `Forwarders`
  ...
  - เพิ่ม IP Address ของ DNS Server ภายนอกที่ต้องการใช้งาน
    ...
    ![technitium-dns-5](/images/technitium/technitium-dns-5.png)
...
![technitium-dns-6](/images/technitium/technitium-dns-6.png)
...
![technitium-dns-7](/images/technitium/technitium-dns-7.png)

- เสร็จสิ้นขั้นตอนการสร้าง Forward zone `example.com`

![technitium-dns-8](/images/technitium/technitium-dns-8.png)
...
![technitium-dns-9](/images/technitium/technitium-dns-9.png)

- เสร็จสิ้นขั้นตอนการสร้าง Reverse zone สำหรับเน็ตเวิร์ค `192.168.0.0/24`

![technitium-dns-10](/images/technitium/technitium-dns-10.png)
