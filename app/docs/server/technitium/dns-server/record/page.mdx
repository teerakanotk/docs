...
ขั้นตอนการเพิ่ม A Record ที่ Forward zone
...
- ไปที่เมนู `Zones` \> คลิกที่ `ชื่อ Zone` (เช่น `example.com`)
- คลิกปุ่ม `Add Record`
...
- สร้างเซิร์ฟเวอร์ 1 เครื่อง และกำหนด IP Address เป็นค่าเดียวกันกับ A Record `www.example.com`
...
- ที่เครื่อง Client ทดลองเข้าเว็บไซต์ผ่าน URL เช่น
```
